/*
$HOME/bin_tr29124/bin/g++ -std=gnu++17 -g -Wall -Wextra -I. -o test_exp test_exp.cpp -lquadmath
./test_exp > test_exp.txt

$HOME/bin/bin/g++ -std=gnu++17 -g -Wall -Wextra -I. -o test_exp test_exp.cpp -lquadmath
./test_exp > test_exp.txt
*/
