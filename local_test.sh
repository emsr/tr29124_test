...
${copy} check/check_beta.cc             ${test_dir}/03_beta/check_value.cc
${copy} check/check_comp_ellint_1.cc    ${test_dir}/04_comp_ellint_1/check_value.cc
${copy} check/check_comp_ellint_2.cc    ${test_dir}/05_comp_ellint_2/check_value.cc
${copy} check/check_comp_ellint_3.cc    ${test_dir}/06_comp_ellint_3/check_value.cc
...
${copy} check/check_ellint_1.cc         ${test_dir}/11_ellint_1/check_value.cc
${copy} check/check_ellint_2.cc         ${test_dir}/12_ellint_2/check_value.cc
${copy} check/check_ellint_3.cc         ${test_dir}/13_ellint_3/check_value.cc
${copy} check/check_expint.cc           ${test_dir}/14_expint/check_value.cc
${copy} check/check_hermite.cc          ${test_dir}/15_hermite/check_value.cc
${copy} check/check_laguerre.cc         ${test_dir}/16_laguerre/check_value.cc
${copy} check/check_legendre.cc         ${test_dir}/17_legendre/check_value.cc
${copy} check/check_riemann_zeta.cc     ${test_dir}/18_riemann_zeta/check_value.cc
${copy} check/check_sph_bessel.cc       ${test_dir}/19_sph_bessel/check_value.cc
${copy} check/check_sph_legendre.cc     ${test_dir}/20_sph_legendre/check_value.cc
${copy} check/check_sph_neumann.cc      ${test_dir}/21_sph_neumann/check_value.cc
...
${copy} check/check_dirichlet_lambda.cc   ${text_dir}/dirichlet_lambda/check_value.cc
${copy} check/check_double_factorial.cc   ${text_dir}/double_factorial/check_value.cc
${copy} check/check_ellint_d.cc           ${text_dir}/ellint_d/check_value.cc
${copy} check/check_ellint_rc.cc          ${text_dir}/ellint_rc/check_value.cc
${copy} check/check_ellint_rd.cc          ${text_dir}/ellint_rd/check_value.cc
${copy} check/check_ellint_rf.cc          ${text_dir}/ellint_rf/check_value.cc
${copy} check/check_ellint_rg.cc          ${text_dir}/ellint_rg/check_value.cc
${copy} check/check_ellint_rj.cc          ${text_dir}/ellint_rj/check_value.cc
${copy} check/check_ellnome.cc            ${text_dir}/ellnome/check_value.cc
${copy} check/check_expint_en.cc          ${text_dir}/expint/check_value.cc
...
${copy} check/check_gamma_l.cc            ${text_dir}/gamma_l/check_value.cc
${copy} check/check_gamma_u.cc            ${text_dir}/gamma_u/check_value.cc
...
${copy} check/check_hyperg.cc             ${text_dir}/hyperg/check_value.cc
${copy} check/check_ibeta.cc              ${text_dir}/ibeta/check_value.cc
${copy} check/check_jacobi.cc             ${text_dir}/jacobi/check_value.cc
...
${copy} check/check_lpochhammer_l.cc      ${text_dir}/lpochhammer_l/check_value.cc
${copy} check/check_lpochhammer_u.cc      ${text_dir}/lpochhammer_u/check_value.cc
${copy} check/check_owens_t.cc            ${text_dir}/owens_t/check_value.cc
${copy} check/check_pgamma.cc             ${text_dir}/pgamma/check_value.cc
${copy} check/check_pochhammer_l.cc       ${text_dir}/pochhammer_l/check_value.cc
${copy} check/check_pochhammer_u.cc       ${text_dir}/pochhammer_u/check_value.cc
${copy} check/check_psi.cc                ${text_dir}/psi/check_value.cc
${copy} check/check_qgamma.cc             ${text_dir}/qgamma/check_value.cc
${copy} check/check_radpoly.cc            ${text_dir}/radpoly/check_value.cc
${copy} check/check_shi.cc                ${text_dir}/sinhint/check_shi.cc
${copy} check/check_sinc.cc               ${text_dir}/sinc/check_value.cc
...
${copy} check/check_theta_4.cc            ${text_dir}/theta_4/check_value.cc
${copy} check/check_zernike.cc            ${text_dir}/zernike/check_value.cc
...
#${copy} check_tr1_assoc_laguerre.cc   ${tr1_dir}/01_assoc_laguerre/check_value.cc
#${copy} check_tr1_assoc_legendre.cc   ${tr1_dir}/02_assoc_legendre/check_value.cc
#${copy} check_tr1_beta.cc             ${tr1_dir}/03_beta/check_value.cc
#${copy} check_tr1_comp_ellint_1.cc    ${tr1_dir}/04_comp_ellint_1/check_value.cc
#${copy} check_tr1_comp_ellint_2.cc    ${tr1_dir}/05_comp_ellint_2/check_value.cc
#${copy} check_tr1_comp_ellint_3.cc    ${tr1_dir}/06_comp_ellint_3/check_value.cc
#${copy} check_tr1_conf_hyperg.cc      ${tr1_dir}/07_conf_hyperg/check_value.cc
#${copy} check_tr1_cyl_bessel_i.cc     ${tr1_dir}/08_cyl_bessel_i/check_value.cc
#${copy} check_tr1_cyl_bessel_j.cc     ${tr1_dir}/09_cyl_bessel_j/check_value.cc
#${copy} check_tr1_cyl_bessel_k.cc     ${tr1_dir}/10_cyl_bessel_k/check_value.cc
#${copy} check_tr1_cyl_neumann.cc      ${tr1_dir}/11_cyl_neumann/check_value.cc
#${copy} check_tr1_ellint_1.cc         ${tr1_dir}/12_ellint_1/check_value.cc
#${copy} check_tr1_ellint_2.cc         ${tr1_dir}/13_ellint_2/check_value.cc
#${copy} check_tr1_ellint_3.cc         ${tr1_dir}/14_ellint_3/check_value.cc
#${copy} check_tr1_expint_neg.cc       ${tr1_dir}/15_expint/check_value_neg.cc
#${copy} check_tr1_expint_pos.cc       ${tr1_dir}/15_expint/check_value_pos.cc
#${copy} check_tr1_hermite.cc          ${tr1_dir}/16_hermite/check_value.cc
#${copy} check_tr1_hyperg.cc           ${tr1_dir}/17_hyperg/check_value.cc
#${copy} check_tr1_laguerre.cc         ${tr1_dir}/18_laguerre/check_value.cc
#${copy} check_tr1_legendre.cc         ${tr1_dir}/19_legendre/check_value.cc
#${copy} check_tr1_riemann_zeta_neg.cc ${tr1_dir}/20_riemann_zeta/check_value_neg.cc
#${copy} check_tr1_riemann_zeta_pos.cc ${tr1_dir}/20_riemann_zeta/check_value_pos.cc
#${copy} check_tr1_sph_bessel.cc       ${tr1_dir}/21_sph_bessel/check_value.cc
#${copy} check_tr1_sph_legendre.cc     ${tr1_dir}/22_sph_legendre/check_value.cc
#${copy} check_tr1_sph_neumann.cc      ${tr1_dir}/23_sph_neumann/check_value.cc
