...
template<typename _Tp>
  void
  _Chebyshev::_Chebyshev(const _Tp __a, const _Tp __b, const unsigned __n, _Tp __func(const _Tp))
  {
    __lower = __a;
    __upper = __b;
    __coef.resize(__n);
...
template<typename _Tp>
  void
  _Chebyshev::deriv(std::vector<_Tp> & __cder)
  {
...
template<typename _Tp>
  void
  _Chebyshev::integ(std::vector<_Tp> & __cint)
  {
...
template<typename _Tp>
  void
  _Chebyshev::to_poly(std::vector<_Tp> & __d)
  {
    const unsigned int __n = __coef.size()
...
template<typename _Tp>
  void
  poly_to_chebyshev(const _Tp a, const _Tp b, const std::vector<_Tp> & d, std::vector<_Tp> & c)
  {
...
template<typename _Tp>
  void
  poly_economize(const _Tp a, const _Tp b, std::vector<_Tp> & d, std::vector<_Tp> & c, int & mfew, const _Tp err)
  {
...
template<typename _Tp>
  _Tp
  clenshaw_curtis_quad(const _Tp a, const _Tp b, const std::vector<_Tp> & c, const _Tp eps)
  {
    if (eps <= _Tp(0))
