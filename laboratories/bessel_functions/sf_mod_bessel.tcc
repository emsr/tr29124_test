...
namespace detail
{
  ...
  template<typename Tp>
      ...
      else
	{
      ...
      for (int i = 1; i <= n; ++i)
	_Kmu = std::exchange(_Kmu1, (mu + Tp(i)) * xi2 * _Kmu1 + _Kmu);
      auto _Knu = _Kmu;
  ...
  template<typename Tp>
	...
	{
	  const auto _Bess13 = cyl_bessel_jn(Tp{1} / Tp{3}, xi);
	  ...
	  const auto _Bess23 = cyl_bessel_jn(Tp{2} / Tp{3}, xi);
  ...
  template<typename Tp>
    ...
    fock_airy(Tp x)
    {
      ...
      using fock_t = emsr::fock_airy_t<Tp, _Cmplx>;
