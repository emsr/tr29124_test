...
/** @file new_modified_bessel_func.tcc
 */
...
#ifndef NEW_MODIFIED_BESSEL_FUNC_TCC
#define NEW_MODIFIED_BESSEL_FUNC_TCC 1
...
namespace detail
{
                    ...
                    Tp & si, Tp & sk, Tp & sip, Tp & skp)
    {
      ...
      si = factor * I_nu;
      sk = factor * K_nu;
      sip = factor * Ip_nu - si / (Tp(2) * x);
      skp = factor * Kp_nu - sk / (Tp(2) * x);
...
#endif // NEW_MODIFIED_BESSEL_FUNC_TCC
