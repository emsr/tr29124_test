...
template<typename Tp>
  ...
  test_carlson()
  {
    ...
    std::cout << "R_F(1, 2, 0) = " << emsr::ellint_rf(1.0, Tp{2}, Tp{0}) << '\n';  //  1.3110287771461
    std::cout << "R_F(i, -i, 0) = " << emsr::ellint_rf(Cmplx(Tp{0}, 1.0),
						   Cmplx(Tp{0}, Tp{-1}),
						   Tp{0}) << '\n';  //  1.8540746773014;
    ...
    std::cout << "R_C(0, i) = " << emsr::ellint_rc(Tp{0},
							 Cmplx(Tp{0}, 1.0)) << '\n';  //  (1 - i) 1.1107207345396
    ...
    std::cout << "R_J(2, 3, 4, -1 + i) = " << emsr::ellint_rj(Tp{2},
								    Tp{3},
								    Tp{4},
    ...
    std::cout << "R_D(i, -i, 2) = " << emsr::ellint_rd(Cmplx(Tp{0},1.0),
						   Cmplx(Tp{0},Tp{-1}),
						   Tp{2}) << '\n';  //  0.65933854154220
    std::cout << "R_D(0, i, -i) = " << emsr::ellint_rd(Tp{0},
						   Cmplx(Tp{0},1.0),
						   Cmplx(Tp{0},Tp{-1})) << '\n';  //  1.2708196271910 + i 2.7811120159521
    std::cout << "R_D(0, i - 1, i) = " << emsr::ellint_rd(Tp{0},
						      Cmplx(Tp{-1},1.0),
    ...
    std::cout << "R_G(0, i, -i) = " << emsr::ellint_rg(Tp{0},
						   Cmplx(Tp{0},1.0),
						   Cmplx(Tp{0},Tp{-1})) << '\n';  //  0.42360654239699
