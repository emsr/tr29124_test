...
template<typename Tp>
  ...
  test_carlson()
  {
    ...
    std::cout << "R_F(i, -i, 0) = " << emsr::ellint_rf(Cmplx(Tp{0}, Tp{1}),
						   Cmplx(Tp{0}, Tp{-1}),
						   Cmplx(Tp{0}, Tp{0})) << '\n';  //  1.8540746773014;
    std::cout << "R_F(i - 1, i, 0) = " << emsr::ellint_rf(Cmplx(Tp{-1}, Tp{1}),
						      Cmplx(Tp{0}, Tp{1}),
    ...
    std::cout << "R_F(i, -i, 2) = " << emsr::ellint_rf(Cmplx(Tp{0}, Tp{1}),
						   Cmplx(Tp{0}, Tp{-1}),
						   Cmplx(Tp{2}, Tp{0})) << '\n';  //  1.0441445654064
    std::cout << "R_F(i - 1, 1 - i, i) = " << emsr::ellint_rf(Cmplx(Tp{-1}, Tp{1}),
							  Cmplx(Tp{1}, Tp{-1}),
    ...
    std::cout << "R_C(i, -1) = " << emsr::ellint_rc(Cmplx(Tp{0}, Tp{1}),
    ...
    std::cout << "R_J(i, -i, 0, 2) = " << emsr::ellint_rj(Cmplx(Tp{0},Tp{1}),
								Cmplx(Tp{0},Tp{-1}),
								Cmplx(Tp{0},Tp{0}),
					     			Cmplx(Tp{2},Tp{0})) << '\n';  //  1.6490011662711
    std::cout << "R_J(-1 + i, -1 - i, 1, 2) = " << emsr::ellint_rj(Cmplx(Tp{-1},Tp{1}),
							       Cmplx(Tp{-1},Tp{-1}),
							       Cmplx(Tp{1},Tp{0}),
							       Cmplx(Tp{2},Tp{0})) << '\n';  //  0.94148358841220
    std::cout << "R_J(i, -i, 0, 1 - i) = " << emsr::ellint_rj(Cmplx(Tp{0},Tp{1}),
							  Cmplx(Tp{0},Tp{-1}),
							  Cmplx(Tp{0},Tp{0}),
							  Cmplx(Tp{1},Tp{-1})) << '\n';  //  1.8260115229009 + i 1.2290661908643
    std::cout << "R_J(-1 + i, -1 - i, 1, -3 + i) = " << emsr::ellint_rj(Cmplx(Tp{-1},Tp{1}),
								    Cmplx(Tp{-1},Tp{-1}),
								    Cmplx(Tp{1},Tp{0}),
								    Cmplx(Tp{-3},Tp{1})) << '\n';  //  -0.61127970812028 - i 1.0684038390007
    std::cout << "R_J(-1 + i, -2 - i, -i, -1 + i) = " << emsr::ellint_rj(Cmplx(Tp{-1},Tp{1}),
								     Cmplx(Tp{-2},Tp{-1}),
								     Cmplx(Tp{0},Tp{-1}),
    ...
    std::cout << "R_D(i, -i, 2) = " << emsr::ellint_rd(Cmplx(Tp{0},Tp{1}),
						   Cmplx(Tp{0},Tp{-1}),
						   Cmplx(Tp{2},Tp{0})) << '\n';  //  0.65933854154220
    ...
    std::cout << "R_G(0, i, -i) = " << emsr::ellint_rg(Cmplx(Tp{0},Tp{0}),
						   Cmplx(Tp{0},Tp{1}),
						   Cmplx(Tp{0},Tp{-1})) << '\n';  //  0.42360654239699
    std::cout << "R_G(i - 1, i, 0) = " << emsr::ellint_rg(Cmplx(Tp{-1},Tp{1}),
						    Cmplx(Tp{0},Tp{1}),
