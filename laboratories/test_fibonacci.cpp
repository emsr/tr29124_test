/*
$HOME/bin/bin/g++ -std=gnu++17 -g -Wall -Wextra -Wno-psabi -I. -o test_fibonacci test_fibonacci.cpp -Lwrappers/debug -lquadmath -Lwrappers/debug -lwrap_gsl -lwrap_burkhardt -lgfortran
