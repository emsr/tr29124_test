/*
$HOME/bin_specfun/bin/g++ -std=gnu++2a -g -Wall -Wextra -Wno-psabi -I. -o test_hydrogen test_hydrogen.cpp -lquadmath -Lwrappers/debug -lwrap_gsl
LD_LIBRARY_PATH=wrappers/debug:$LD_LIBRARY_PATH ./test_hydrogen > test_hydrogen.txt

$HOME/bin/bin/g++ -std=c++2a -std=gnu++2a -g -Wall -Wextra -I. -o test_hydrogen test_hydrogen.cpp -lquadmath -Lwrappers/debug -lwrap_gsl
