...
plot [-5.0:2.0][-1.5:+1.5] \
    "plot/fgh_double.txt" using 1:2 with lines title "fai", \
                       "" using 1:3 with lines title "gai", \
                       "" using 1:4 with lines title "hai"

plot [-5.0:2.0][-2.5:+2.5] \
    "plot/fgh_double.txt" using 1:5 with lines title "fai'", \
                       "" using 1:6 with lines title "gai'", \
                       "" using 1:7 with lines title "hai'"

plot [-5.0:2.0][-2.5:+2.5] \
    "plot/fgh_double.txt" using 1:($2+$3+$4) with lines title "Hi"

plot [-5.0:2.0][-2.5:+2.5] \
    "plot/fgh_double.txt" using 1:($5+$6+$7) with lines title "Hi'"
...
# Scorer
plot [-20.0:5.0][-1.0:+1.0] \
    "plot/scorer_float.txt" using 1:2 with lines title "Gi", \
                         "" using 1:3 with lines title "Gi'", \
                         "" using 1:4 with lines title "Hi", \
                         "" using 1:5 with lines title "Hi'"
...
plot [-20.0:5.0][-1.0:+1.0] \
    "plot/scorer_long_double.txt" using 1:2 with lines title "Gi", \
                               "" using 1:3 with lines title "Gi'", \
                               "" using 1:4 with lines title "Hi", \
                               "" using 1:5 with lines title "Hi'"
...
# Airy
plot [-20.0:5.0][-1.0:+1.0] \
    "plot/airy_float.txt" using 1:2 with lines title "Ai(x)", \
...
plot [-20.0:5.0][-1.5:+1.5] \
    "plot/airy_float.txt" using 1:4 with lines title "Bi(x)", \
                       "" using 1:5 with lines title "Bi'(x)"


plot [-20.0:5.0][-1.0:+1.0] \
    "plot/airy_double.txt" using 1:2 with lines title "Ai(x)", \
                        "" using 1:4 with lines title "Bi(x)"
...
plot [-20.0:5.0][-1.5:+1.5] \
    "plot/airy_double.txt" using 1:4 with lines title "Bi(x)", \
                        "" using 1:5 with lines title "Bi'(x)"


plot [-20.0:5.0][-1.0:+1.0] \
    "plot/airy_long_double.txt" using 1:2 with lines title "Ai(x)", \
                             "" using 1:4 with lines title "Bi(x)"
...
plot [-20.0:5.0][-1.5:+1.5] \
    "plot/airy_long_double.txt" using 1:4 with lines title "Bi(x)", \
                             "" using 1:5 with lines title "Bi'(x)"


# Struve
plot [0.0:30.0][-0.5:+6.0] \
    "plot/struve_float.txt" using 1:2 with lines title "{/:Bold H}_0", \
...
plot [0.0:5.0][-0.5:+4.5] \
    "plot/struve_float.txt" using 1:3 with lines title "{/:Bold L}_0", \
                         "" using 1:5 with lines title "{/:Bold L}_1", \
                         "" using 1:7 with lines title "{/:Bold L}_2", \
                         "" using 1:9 with lines title "{/:Bold L}_3"

plot [0.0:30.0][-0.5:+6.0] \
    "plot/struve_double.txt" using 1:2 with lines title "{/:Bold H}_0", \
                          "" using 1:4 with lines title "{/:Bold H}_1", \
                          "" using 1:6 with lines title "{/:Bold H}_2", \
                          "" using 1:8 with lines title "{/:Bold H}_3"

plot [0.0:5.0][-0.5:+4.5] \
    "plot/struve_double.txt" using 1:3 with lines title "{/:Bold L}_0", \
                          "" using 1:5 with lines title "{/:Bold L}_1", \
                          "" using 1:7 with lines title "{/:Bold L}_2", \
                          "" using 1:9 with lines title "{/:Bold L}_3"

plot [0.0:30.0][-0.5:+6.0] \
    "plot/struve_long_double.txt" using 1:2 with lines title "{/:Bold H}_0", \
                               "" using 1:4 with lines title "{/:Bold H}_1", \
                               "" using 1:6 with lines title "{/:Bold H}_2", \
                               "" using 1:8 with lines title "{/:Bold H}_3"

plot [0.0:5.0][-0.5:+4.5] \
    "plot/struve_long_double.txt" using 1:3 with lines title "{/:Bold L}_0", \
                               "" using 1:5 with lines title "{/:Bold L}_1", \
                               "" using 1:7 with lines title "{/:Bold L}_2", \
                               "" using 1:9 with lines title "{/:Bold L}_3"
