...
namespace std
{
  ...
  reperiod_t<float> atan_pif(sincos_pi_t<float> m);
  reperiod_t<double> atan_pi(sincos_pi_t<double> m);
  reperiod_t<long double> atan_pil(sincos_pi_t<long double> m);
  ...
  reperiod_t<float> acot_pif(sincos_pi_t<float> m);
  reperiod_t<double> acot_pi(sincos_pi_t<double> m);
  reperiod_t<long double> acot_pil(sincos_pi_t<long double> m);
