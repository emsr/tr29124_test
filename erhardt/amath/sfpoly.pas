...
(*************************************************************************
 ...
 REMARKS       :  - The absolute values of l,m (degree/order) for the
                  ...
                  - The unit can be compiled with TP5 but some functions generate
...
(*
{With unit sfhyperg use this function}
{---------------------------------------------------------------------------}
function lq_hf(l: integer; x: extended): extended;
var
  f,t: extended;
begin
  f := sfc_2f1(1+0.5*l, 0.5*(l+1), l+1.5, 1/sqr(x));
  t := sfc_gamma_ratio(l+1,l+1.5);
