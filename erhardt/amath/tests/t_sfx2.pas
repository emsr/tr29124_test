{Part 2 of regression test for SPECFUNX unit  (c) 2010-2015  W.Ehrhardt}
...
{$ifndef VER50}
  ...
  for i:=1 to 500 do begin
    ...
    b  := randx;
    y  := el2x(x,kc,a,b);
    f  := a*x*ell_rfx(1,1+sqr(kc*x), 1+sqr(x)) +
          (b-a)/3.0*x*x*x*ell_rdx(1,1+sqr(kc*x), 1+sqr(x));
