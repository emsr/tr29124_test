...
{define NOBASM to test TP5/6 routines with BP7}
...
begin
  sep_line;
  testfun('amath.langevin',{$ifdef FPC_ProcVar}@{$endif}langevin, {$ifdef FPC_ProcVar}@{$endif}mpf_langevin, -1, 1);
  testfun('amath.langevin',{$ifdef FPC_ProcVar}@{$endif}langevin, {$ifdef FPC_ProcVar}@{$endif}mpf_langevin, -30,-1);
end;
...
begin
  ...
  writeln('Test AMath V', AMath_Version,' with MP_Arith V', MP_VERSION, '   (c) 2009-2015 W.Ehrhardt');
