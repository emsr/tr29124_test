{Main test unit AMTools  (c) W.Ehrhardt 2010-2013}
...
begin
  ...
  writeln('Test program for AMTools unit    (c) W.Ehrhardt 2010-2013');
...
begin
  ...
  if (flag=0.0) or (frac(flag)=0.0) then begin
    inc(fail);
    writeln('quanc8 qt2: ',err:28, est:28);
  end;
...
procedure test_amint;
  {-Test numerical integration}
begin
  writeln('Test AMTools/numerical integration    (c) W.Ehrhardt 2011-2013');
  totalfail := 0;
  totalcnt  := 0;
  test_quanc8;
  test_quagk;
