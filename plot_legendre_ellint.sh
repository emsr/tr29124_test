...
plot [0.0:1.6][0.0:3.5] \
                    "test_legendre_ellint.txt" index 1 using 1:2 with lines title "F(0.0,{/Symbol f})", \
...
plot [0.0:1.0][1.0:1.6] \
                    "test_legendre_ellint.txt" index 2 using 1:2 with lines title "E(k)", \
...
plot [0.0:1.6][0.0:1.6] \
                    "test_legendre_ellint.txt" index 3 using 1:2 with lines title "E(0.0,{/Symbol f})", \
