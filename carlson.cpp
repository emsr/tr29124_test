...
// ../bin/bin/g++ -g -std=c++0x -o carlson carlson.cpp
...
//long double __pi = 3.1415926535897932384626433832795029L;
...
main()
{
  ...
  std::cout << "R_F(i, -i, 0) = " << __gnu_cxx::__ellint_rf(std::complex<double>(0.0, 1.0),
						 std::complex<double>(0.0, -1.0),
						 std::complex<double>(0.0, 0.0)) << std::endl;  //  1.8540746773014;
  std::cout << "R_F(i - 1, i, 0) = " << __gnu_cxx::__ellint_rf(std::complex<double>(-1.0, 1.0),
						    std::complex<double>(0.0, 1.0),
						    std::complex<double>(0.0, 0.0)) << std::endl;  //  0.79612586584234 - i 1.2138566698365
  ...
  std::cout << "R_F(i, -i, 2) = " << __gnu_cxx::__ellint_rf(std::complex<double>(0.0, 1.0),
						 std::complex<double>(0.0, -1.0),
						 std::complex<double>(2.0, 0.0)) << std::endl;  //  1.0441445654064
  std::cout << "R_F(i - 1, 1 - i, i) = " << __gnu_cxx::__ellint_rf(std::complex<double>(-1.0, 1.0),
  ...
  std::cout << "R_C(0, i) = " << __gnu_cxx::__ellint_rc(std::complex<double>(0.0, 0.0),
						       std::complex<double>(0.0, 1.0)) << std::endl;  //  (1 - i) 1.1107207345396
  std::cout << "R_C(-i, i) = " << __gnu_cxx::__ellint_rc(std::complex<double>(0.0, -1.0),
  ...
  std::cout << "R_C(i, -1) = " << __gnu_cxx::__ellint_rc(std::complex<double>(0.0, 1.0),
							std::complex<double>(-1.0, 0.0)) << std::endl;  //  0.77778596920447 + i 0.19832484993429
  ...
  std::cout << "R_J(2, 3, 4, -1 + i) = " << __gnu_cxx::__ellint_rj(std::complex<double>(2.0,0.0),
  ...
  std::cout << "R_J(i, -i, 0, 2) = " << __gnu_cxx::__ellint_rj(std::complex<double>(0.0,1.0),
							      std::complex<double>(0.0,-1.0),
							      std::complex<double>(0.0,0.0),
					     		      std::complex<double>(2.0,0.0)) << std::endl;  //  1.6490011662711
  std::cout << "R_J(-1 + i, -1 - i, 1, 2) = " << __gnu_cxx::__ellint_rj(std::complex<double>(-1.0,1.0),
							     std::complex<double>(-1.0,-1.0),
							     std::complex<double>(1.0,0.0),
							     std::complex<double>(2.0,0.0)) << std::endl;  //  0.94148358841220
  std::cout << "R_J(i, -i, 0, 1 - i) = " << __gnu_cxx::__ellint_rj(std::complex<double>(0.0,1.0),
							std::complex<double>(0.0,-1.0),
							std::complex<double>(0.0,0.0),
							std::complex<double>(1.0,-1.0)) << std::endl;  //  1.8260115229009 + i 1.2290661908643
  std::cout << "R_J(-1 + i, -1 - i, 1, -3 + i) = " << __gnu_cxx::__ellint_rj(std::complex<double>(-1.0,1.0),
								  std::complex<double>(-1.0,-1.0),
								  std::complex<double>(1.0,0.0),
								  std::complex<double>(-3.0,1.0)) << std::endl;  //  -0.61127970812028 - i 1.0684038390007
  std::cout << "R_J(-1 + i, -2 - i, -i, -1 + i) = " << __gnu_cxx::__ellint_rj(std::complex<double>(-1.0,1.0),
  ...
  std::cout << "R_D(i, -i, 2) = " << __gnu_cxx::__ellint_rd(std::complex<double>(0.0,1.0),
						 std::complex<double>(0.0,-1.0),
						 std::complex<double>(2.0,0.0)) << std::endl;  //  0.65933854154220
  std::cout << "R_D(0, i, -i) = " << __gnu_cxx::__ellint_rd(std::complex<double>(0.0,0.0),
						 std::complex<double>(0.0,1.0),
						 std::complex<double>(0.0,-1.0)) << std::endl;  //  1.2708196271910 + i 2.7811120159521
  std::cout << "R_D(0, i - 1, i) = " << __gnu_cxx::__ellint_rd(std::complex<double>(0.0,0.0),
						    std::complex<double>(-1.0,1.0),
						    std::complex<double>(0.0,1.0)) << std::endl;  //  -1.8577235439239 - i 0.96193450888839
  std::cout << "R_D(-2 - i, -i, -1 + i) = " << __gnu_cxx::__ellint_rd(std::complex<double>(-2.0,-1.0),
							   std::complex<double>(0.0,-1.0),
							   std::complex<double>(-1.0,1.0)) << std::endl;  //  1.8249027393704 - i 1.2218475784827
  ...
  std::cout << "R_G(i - 1, i, 0) = " << __gnu_cxx::__ellint_rg(std::complex<double>(-1.0,1.0),
						  std::complex<double>(0.0,1.0),
						  std::complex<double>(0.0,0.0)) << std::endl;  //  0.44660591677018 + i 0.70768352357515
  std::cout << "R_G(-i, i - 1, i) = " << __gnu_cxx::__ellint_rg(std::complex<double>(0.0,-1.0),
						  std::complex<double>(-1.0,1.0),
  ...
  ////std::cout << "K(pi/2) = " << __comp_ellint_1(std::complex<double>(__pi_2, 0.0)) << std::endl;  //  1.5887715763658593607082818553065 - 1.3986463677643598308560440635658*i
