...
$(CHECK_DIR)/pr86655_assoc_legendre: $(CHECK_DIR)/pr86655_assoc_legendre.cc
	$(CXX14) -Iinclude -Ipolynomial/include -I$(CXX_TEST_INC_DIR) -D_GLIBCXX_ASSERT -D__TEST_DEBUG -o $(CHECK_DIR)/pr86655_assoc_legendre $(CHECK_DIR)/pr86655_assoc_legendre.cc -lquadmath

$(CHECK_DIR)/pr86655_sph_legendre: $(CHECK_DIR)/pr86655_sph_legendre.cc
	$(CXX14) -Iinclude -Ipolynomial/include -I$(CXX_TEST_INC_DIR) -D_GLIBCXX_ASSERT -D__TEST_DEBUG -o $(CHECK_DIR)/pr86655_sph_legendre $(CHECK_DIR)/pr86655_sph_legendre.cc -lquadmath
...
$(CHECK_DIR)/pr86655_tr1_assoc_legendre: $(CHECK_DIR)/pr86655_tr1_assoc_legendre.cc
	$(CXX14) -Iinclude -Ipolynomial/include -I$(CXX_TEST_INC_DIR) -D_GLIBCXX_ASSERT -D__TEST_DEBUG -o $(CHECK_DIR)/pr86655_tr1_assoc_legendre $(CHECK_DIR)/pr86655_tr1_assoc_legendre.cc -lquadmath

$(CHECK_DIR)/pr86655_tr1_sph_legendre: $(CHECK_DIR)/pr86655_tr1_sph_legendre.cc
	$(CXX14) -Iinclude -Ipolynomial/include -I$(CXX_TEST_INC_DIR) -D_GLIBCXX_ASSERT -D__TEST_DEBUG -o $(CHECK_DIR)/pr86655_tr1_sph_legendre $(CHECK_DIR)/pr86655_tr1_sph_legendre.cc -lquadmath
