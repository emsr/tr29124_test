...
splot [-20:5][-5:5][-40:20] "plot/gamma_lanczos_float.txt" index 0 with lines title "Re(logGamma(z))"
...
splot [-20:5][-5:5][-40:20] "plot/gamma_lanczos_double.txt" index 0 with lines title "Re(logGamma(z))"
...
splot [-20:5][-5:5][-40:20] "plot/gamma_lanczos_long_double.txt" index 0 with lines title "Re(logGamma(z))"
splot [-20:5][-5:5][-20:20] "plot/gamma_lanczos_long_double.txt" index 1 with lines title "Im(logGamma(z))"
...
splot [-20:5][-5:5][-40:20] "plot/gamma_spouge_float.txt" index 0 with lines title "Re(logGamma(z))"
...
splot [-20:5][-5:5][-40:20] "plot/gamma_spouge_double.txt" index 0 with lines title "Re(logGamma(z))"
...
splot [-20:5][-5:5][-40:20] "plot/gamma_spouge_long_double.txt" index 0 with lines title "Re(logGamma(z))"
