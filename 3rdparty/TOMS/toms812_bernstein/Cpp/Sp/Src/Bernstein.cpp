...
{ 
  ...
  try {  cf = new double[dgr + 1];  }
    ...
    std::cout << "In constructing a Bernstein object: " << exception.what() << '\n';  
    dgr = -1;
  }
...
Bernstein getprimes(int nn, int prNum, int mode)
{
  ...
  try {  output.cf = new double[output.dgr + 1];  }
    ...
    std::cout << "In function getprimes(): " << exception.what() << '\n';
    output.dgr = -1;
    return output;
  }
...
Bernstein factorization(int nn, int kk)
{
  ...
  if ( (nn < kk) || (kk < 0) )
    ...
    try {  exp.cf = new double[exp.dgr + 1];  }
      ...
      std::cout << "In function factorization(): " << exception.what() << '\n';
      exp.dgr = -1;
      return exp;
    }
...
Bernstein binomult(const Bernstein &e1, const Bernstein &e2)
{
  ...
  if ( n1 == -1 || n2 == -1 )
    ...
    try {  output.cf = new double[output.dgr + 1];  }
      ...
      std::cout << "In function binomult(): " << exception.what() << '\n';
      output.dgr = -1;
      return output;
    }
...
Bernstein binodiv(const Bernstein &e1, const Bernstein &e2)
{
  ...
  else if ( n1 > n2 )
  {
    ...
    try {  output.cf = new double[output.dgr + 1];  }
      ...
      std::cout << "In function binodiv(): " << exception.what() << '\n';
      output.dgr = -1;
      return output;
    }
    for ( ii = 1; ii <= n2; ii++ )        
...
Bernstein DE(const Bernstein &uu, int rr)
{
  ...
  try {  result.cf = new double[result.dgr + 1];  }
    ...
    std::cout << "In function DE(): " << exception.what() << '\n';
    result.dgr = -1; 
    return result;
  }
...
double EVAL(const Bernstein &uu, double xx)
{
  ...
  try { 
    ...
    std::cout << "In function EVAL(): " << exception.what() << '\n';
    exit(1);
  }
...
Bernstein subLEFT(const Bernstein &uu, double xx)
{
  ...
  try { 
    ...
    std::cout << "In function subLEFT(): " << exception.what() << '\n';
    LEFT.dgr = -1;
    return LEFT;
  }
...
const Bernstein& Bernstein::operator=(const Bernstein &uu) 
{
  ...
  try {  cf = new double[dgr + 1]; }
    ...
    std::cout << "In function assign(): " << exception.what() << '\n';
    dgr = -1;
    return *this;
  }
...
Bernstein Bernstein::operator+(const Bernstein &uu) const 
{
  ...
  if ( mm == nn ) {
    ...
    try {  result.cf = new double[mm+1];  }
      ...
      std::cout << "In function add(): " << exception.what() << '\n';
      result.dgr = -1;
      return result;
    }
...
Bernstein Bernstein::operator-(const Bernstein &uu) const 
{
  ...
  if ( mm == nn ) {
    ...
    try {  result.cf = new double[mm+1];  }
      ...
      std::cout << "In function subtract(): " << exception.what() << '\n';
      result.dgr = -1;
      return result;
    }
...
Bernstein Bernstein::operator*(const Bernstein &uu) const 
{
  ...
  try {  result.cf = new double[result.dgr + 1];  }
    ...
    std::cout << "In function multiply(): " << exception.what() << '\n';
    result.dgr = -1;
    return result;
  }
...
Bernstein Bernstein::operator/(const Bernstein &uu) const
{
  ...
  try {  
    ...
    std::cout << "In function divide(): " << exception.what() << '\n';
    result.dgr = -1;
    return result;
  }
...
Bernstein quo(const Bernstein &uu, int degree)
{
  ...
  try {  result.cf = new double[result.dgr+1];  }
    ...
    std::cout << "In function quo(): " << exception.what() << '\n';
    result.dgr = -1;
    return result;
  }
...
Bernstein rem(const Bernstein &uu, int degree)
{
  ...
  try {  result.cf = new double[result.dgr+1];  }
    ...
    std::cout << "In function rem(): " << exception.what() << '\n';
    result.dgr = -1;
    return result;
  }
...
Bernstein Bernstein::operator<<(const Bernstein &uu) const
{
  ...
  try {
    ...
    std::cout << "In function composition(): " << exception.what() << '\n';
    result.dgr = -1;
    return result;
  }
...
Bernstein Bernstein::operator^(int power)
{
  ...
  try {  result.cf = new double[result.dgr+1];  }
    ...
    std::cout << "In function power(): " << exception.what() << '\n';
    result.dgr = -1;
    return result;
  }
  result.cf[0] = 1.0;
...
Bernstein operator*(double factor, const Bernstein &uu) 
{
  ...
  try {  result.cf = new double[result.dgr+1];  }
    ...
    std::cout << "In function pre-multiply(): " << exception.what() << '\n';
    result.dgr = -1;
    return result;
  }
...
Bernstein sort(const Bernstein &uu) 
{
  ...
  try {  
    ...
    std::cout << "In function sort(): " << exception.what() << '\n';
    result.dgr = -1;
    return result;
  }
...
Bernstein sROOT(const Bernstein &uu, double delta, double eta)
{
  ...
  // Beware: roots.cf[n] is NOT used !!
    ...
    std::cout << "In function sROOT(): " << exception.what() << '\n';
    roots.dgr = -1;
    return roots;
  }
...
Bernstein mROOT(const Bernstein &uu, double delta, double eta, double epsilon)
{
  ...
  // Beware: roots.cf[n] is NOT used !!
    ...
    std::cout << "In function mROOT(): " << exception.what() << '\n';
    roots.dgr = -1;
    return roots;
  }
