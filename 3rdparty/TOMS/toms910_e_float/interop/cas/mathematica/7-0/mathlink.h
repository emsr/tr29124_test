...
#define MLCHIHUAHUA_CLONGDOUBLE    MLTK_96BIT_HIGHPADDED_INTEL_80BIT_EXTENDED
...
#define MLCHIHUAHUA_MLLONGDOUBLE   MLTK_96BIT_HIGHPADDED_INTEL_80BIT_EXTENDED
...
#		define MLTK_CLONGDOULBE   MLNORWICHTERRIOR_CLONGDOUBLE
...
#define PPC_SESS_REF_NUM       MLDEVICE_MASK + (PPC_TYPE * 256UL + 0UL)         /* PPCSessRefNum */
#define PPC_PARTNER_PSN        MLDEVICE_MASK + (PPC_TYPE * 256UL + 1UL)         /* ProcessSerialNumber */
#define PPC_PARTNER_LOCATION   MLDEVICE_MASK + (PPC_TYPE * 256UL + 2UL)         /* LocationNameRec */
#define PPC_PARTNER_PORT       MLDEVICE_MASK + (PPC_TYPE * 256UL + 3UL)         /* PPCPortRec */
#define MACTCP_STREAM          MLDEVICE_MASK + (MACTCP_TYPE * 256UL + 0UL)      /* StreamPtr */
#define MACTCP_PARTNER_ADDR    MLDEVICE_MASK + (MACTCP_TYPE * 256UL + 1UL)      /* ip_addr */
#define MACTCP_PARTNER_PORT    MLDEVICE_MASK + (MACTCP_TYPE * 256UL + 2UL)      /* tcp_port */
#define MACTCP_IPDRIVER        MLDEVICE_MASK + (MACTCP_TYPE * 256UL + 3UL)      /* short */
#define MACTCP_SETSIMPLESOCKET MLDEVICE_MASK + (MACTCP_TYPE * 256UL + 9UL)      /* buf, buflen ignored */
#define COMMTB_CONNHANDLE      MLDEVICE_MASK + (COMMTB_TYPE * 256UL + 0UL)      /* ConnHandle */
#define ADSP_CCBREFNUM         MLDEVICE_MASK + (ADSP_TYPE * 256UL + 0UL)        /* short */
#define ADSP_IOCREFNUM         MLDEVICE_MASK + (ADSP_TYPE * 256UL + 3UL)        /* short */
...
#if MLINTERFACE >= 4
MLDECL(mlint64,                   MLInteger64_FromZero,    (void));
#endif
...
MLDECL( long, MLNextChar,             ( const char **startp, const char *end, int more));
...
#if MLINTERFACE >= 4
MLDECL( int, MLPutInteger8ArrayData, ( MLINK mlp, array_meterp meterp, unsigned char * datap, int count));
#endif
...
#if MLINTERFACE >= 4
MLDECL( int,  MLPutInteger8Array, ( MLINK mlp, unsigned char *data, int *dims, char **heads, int depth));
#endif
...
#if MLINTERFACE >= 4
MLDECL( int, MLPutInteger8List,  (MLINK mlp, unsigned char *data, int count));
#endif
