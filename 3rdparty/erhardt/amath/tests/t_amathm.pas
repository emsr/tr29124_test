{T_AMATHM - regression test main unit for AMATH  (c) 2009-2013  W.Ehrhardt}
...
begin
  total_cnt    := 0;
  total_failed := 0;
  writeln('T_AMATH - main test program for AMATH unit V',AMath_Version,'   (c) 2009-2015  W.Ehrhardt');
