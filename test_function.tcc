...
void runtest(std::tr1::function<Tp(Tp1)> function,
...
void runtest(std::tr1::function<Tp(Tp1,Tp2)> function,
             const std::string & basename,
             const std::vector<Tp1> & argument1,
...
void runtest(std::tr1::function<Tp(Tp1,Tp2,Tp3)> function,
             const std::string & basename,
             const std::vector<Tp1> & argument1,
             const std::vector<Tp2> & argument2,
...
void runtest(std::tr1::function<Tp(Tp1,Tp2,Tp3,Tp4)> function,
             const std::string & basename,
             const std::vector<Tp1> & argument1,
             const std::vector<Tp2> & argument2,
             const std::vector<Tp3> & argument3,
...
///
template<typename Tp, typename Tp1>
void rundiff(std::tr1::function<Tp(Tp1)> function1,
             std::tr1::function<Tp(Tp1)> function2,
...
///
template<typename Tp, typename Tp1, typename Tp2>
void rundiff(std::tr1::function<Tp(Tp1,Tp2)> function1,
             std::tr1::function<Tp(Tp1,Tp2)> function2,
             const std::string & basename,
...
///
template<typename Tp, typename Tp1, typename Tp2, typename Tp3>
void rundiff(std::tr1::function<Tp(Tp1,Tp2,Tp3)> function1,
             std::tr1::function<Tp(Tp1,Tp2,Tp3)> function2,
             const std::string & basename,
             const std::string & arg1, const std::vector<Tp1> & argument1,
             const std::string & arg2, const std::vector<Tp2> & argument2,
...
///
template<typename Tp, typename Tp1, typename Tp2, typename Tp3, typename Tp4>
void rundiff(std::tr1::function<Tp(Tp1,Tp2,Tp3,Tp4)> function1,
             std::tr1::function<Tp(Tp1,Tp2,Tp3,Tp4)> function2,
             const std::string & basename,
             const std::string & arg1, const std::vector<Tp1> & argument1,
             const std::string & arg2, const std::vector<Tp2> & argument2,
             const std::string & arg3, const std::vector<Tp3> & argument3,
