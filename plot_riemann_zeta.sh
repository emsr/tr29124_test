...
splot [-20:5][-5:5][0:80] "plot/riemann_zeta_long_double.txt" index 2 with pm3d title "|{/Symbol z}(s)|"
splot [-20:5][-5:5][-180:180] "plot/riemann_zeta_long_double.txt" index 3 with pm3d title "Arg({/Symbol z}(s))"
