// $HOME/bin_specfun/bin/g++ -g -o test_sph_hankel test_sph_hankel.cpp -lquadmath boost_wrap.cpp

// LD_LIBRARY_PATH=$HOME/bin_specfun/lib64:$LD_LIBRARY_PATH ./test_sph_hankel > test_sph_hankel.txt
