#ifndef TESTCASE3_TCC
#define TESTCASE3_TCC 1
...
template<CONCEPT_MASK MaskFun, CONCEPT_SPECFUN TestFun, CONCEPT_BASELINEFUN BaselineFun,
  ...
  public:
    ...
    testcase3(test_function<TestFun> test,
...
template<CONCEPT_MASK MaskFun, CONCEPT_SPECFUN TestFun, CONCEPT_BASELINEFUN BaselineFun,
         typename Ret, CONCEPT_ARGUMENT... Arg>
  testcase3<MaskFun, TestFun, BaselineFun, Ret, Arg...>
  make_testcase3(test_function<TestFun> test,
		 baseline_function<BaselineFun> base,
		 MaskFun mask,
		 std::string_view structname,
		 Arg... arg)
  {
    return testcase3<MaskFun, TestFun, BaselineFun, Ret, Arg...>(test, base, mask, structname, arg...);
  }
...
template<CONCEPT_MASK MaskFun, CONCEPT_SPECFUN TestFun, CONCEPT_BASELINEFUN BaselineFun,
         typename Ret, CONCEPT_ARGUMENT... Arg>
  template<std::size_t Index>
    struct testcase3<MaskFun, TestFun, BaselineFun, Ret, Arg...>::
    Test_Data_Help<Index, _SpaceLess<std::size_t>>
    {
      void
      operator()(std::ostream & output, const testcase3<MaskFun, TestFun, BaselineFun, Ret, Arg...> & outer) const
      {
	using Outer = testcase3<MaskFun, TestFun, BaselineFun, Ret, Arg...>;
...
template<CONCEPT_MASK MaskFun, CONCEPT_SPECFUN TestFun, CONCEPT_BASELINEFUN BaselineFun,
  ...
  template<std::size_t Index>
    ...
    {
      void
      operator()(std::ostream &, const testcase3<MaskFun, TestFun, BaselineFun, Ret, Arg...> &) const;
    };
