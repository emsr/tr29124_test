...
/*
$HOME/bin/bin/g++ -std=c++14 -g -Wall -Wextra -Wno-psabi -o carlson2 carlson2.cpp
./carlson2 > carlson2.txt
*/
...
template<typename _Tp>
  ...
  test_carlson()
  {
    ...
    std::cout << "R_F(1, 2, 0) = " << __gnu_cxx::ellint_rf(1.0, _Tp{2}, _Tp{0}) << '\n';  //  1.3110287771461
    std::cout << "R_F(i, -i, 0) = " << __gnu_cxx::ellint_rf(_Cmplx(_Tp{0}, 1.0),
						   _Cmplx(_Tp{0}, _Tp{-1}),
						   _Tp{0}) << '\n';  //  1.8540746773014;
    ...
    std::cout << "R_C(0, i) = " << __gnu_cxx::ellint_rc(_Tp{0},
							 _Cmplx(_Tp{0}, 1.0)) << '\n';  //  (1 - i) 1.1107207345396
    ...
    std::cout << "R_J(2, 3, 4, -1 + i) = " << __gnu_cxx::ellint_rj(_Tp{2},
								    _Tp{3},
								    _Tp{4},
    ...
    std::cout << "R_D(i, -i, 2) = " << __gnu_cxx::ellint_rd(_Cmplx(_Tp{0},1.0),
						   _Cmplx(_Tp{0},_Tp{-1}),
						   _Tp{2}) << '\n';  //  0.65933854154220
    std::cout << "R_D(0, i, -i) = " << __gnu_cxx::ellint_rd(_Tp{0},
						   _Cmplx(_Tp{0},1.0),
						   _Cmplx(_Tp{0},_Tp{-1})) << '\n';  //  1.2708196271910 + i 2.7811120159521
    std::cout << "R_D(0, i - 1, i) = " << __gnu_cxx::ellint_rd(_Tp{0},
						      _Cmplx(_Tp{-1},1.0),
    ...
    std::cout << "R_G(0, i, -i) = " << __gnu_cxx::ellint_rg(_Tp{0},
						   _Cmplx(_Tp{0},1.0),
						   _Cmplx(_Tp{0},_Tp{-1})) << '\n';  //  0.42360654239699
