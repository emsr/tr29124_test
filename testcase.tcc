...
template<>
  struct type_strings<float>
  {
    static constexpr std::experimental::string_view
    type()
    { return std::experimental::string_view("float"); }
...
template<typename Tp, typename Tp1>
  ...
  maketest(Tp function1(Tp1),
	   Tp function2(Tp1),
	   const std::experimental::string_view & nsname,
	   const std::experimental::string_view & funcname,
	   const std::experimental::string_view & arg1, const std::vector<Tp1> & argument1,
	   std::ostream & output,
	   bool write_header = true, bool write_main = true, unsigned int test = 1)
  {
    ...
    structname += funcname.to_string();
    structname += '<' + numname.to_string() + '>';
...
template<typename Tp, typename Tp1, typename Tp2>
  ...
  maketest(Tp function1(Tp1,Tp2),
	   ...
	   const std::experimental::string_view & funcname,
	   const std::experimental::string_view & arg1, const std::vector<Tp1> & argument1,
	   const std::experimental::string_view & arg2, const std::vector<Tp2> & argument2,
	   std::ostream & output,
	   bool write_header = true, bool write_main = true, unsigned int test = 1)
  {
    const int old_prec = output.precision(std::numeric_limits<Tp>::max_digits10);
...
template<typename Tp, typename Tp1, typename Tp2, typename Tp3>
  ...
  maketest(Tp function1(Tp1,Tp2,Tp3),
	   ...
	   const std::experimental::string_view & arg1, const std::vector<Tp1> & argument1,
	   const std::experimental::string_view & arg2, const std::vector<Tp2> & argument2,
	   const std::experimental::string_view & arg3, const std::vector<Tp3> & argument3,
	   std::ostream & output,
	   bool write_header = true, bool write_main = true, unsigned int test = 1)
  {
    const int old_prec = output.precision(std::numeric_limits<Tp>::max_digits10);
...
template<typename Tp, typename Tp1, typename Tp2, typename Tp3, typename Tp4>
  ...
  maketest(Tp function1(Tp1,Tp2,Tp3,Tp4),
	   ...
	   const std::experimental::string_view & arg2, const std::vector<Tp2> & argument2,
	   const std::experimental::string_view & arg3, const std::vector<Tp3> & argument3,
	   const std::experimental::string_view & arg4, const std::vector<Tp4> & argument4,
	   std::ostream & output,
	   bool write_header = true, bool write_main = true, unsigned int test = 1)
  {
    const int old_prec = output.precision(std::numeric_limits<Tp>::max_digits10);
