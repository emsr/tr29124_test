...
template<typename Tp>
  void
  test_steed_continued_fraction(Tp proto = Tp{})
  {
    ...
    emsr::SteedContinuedFraction<Tp, AFun, BFun, TailFun>
...
template<typename Tp>
  ...
  test_steed_hypint(Tp proto = Tp{})
  {
    ...
    const auto S_pi_2 = emsr::pi_v<Real> / Tp{2};
