...
template<typename _Real>
  ...
  private:
    ...
    static constexpr auto infty = std::numeric_limits<_Real>::max();
    static constexpr auto small = std::numeric_limits<_Real>::min();
...
x^5 - 113 x^4 + 1333 x^3 - 3331 x^2 + 3110 x - 1000
