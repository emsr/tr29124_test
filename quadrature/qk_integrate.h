...
namespace __gnu_test
{
  ...
  template<typename _VecTp, typename _FuncTp>
	...
	case QK_15: __qk_int_func =
	  (qk_int_func_type)(&(__detail::qk_integrator<_VecTp, _FuncTp, QK_15>::_S_integrate));
	  break;
	case QK_21: __qk_int_func =
	  (qk_int_func_type)(&(__detail::qk_integrator<_VecTp, _FuncTp, QK_21>::_S_integrate));
	  break;
	case QK_31: __qk_int_func =
	  (qk_int_func_type)(&(__detail::qk_integrator<_VecTp, _FuncTp, QK_31>::_S_integrate));
	  break;
	case QK_41: __qk_int_func =
	  (qk_int_func_type)(&(__detail::qk_integrator<_VecTp, _FuncTp, QK_41>::_S_integrate));
	  break;
	case QK_51: __qk_int_func =
	  (qk_int_func_type)(&(__detail::qk_integrator<_VecTp, _FuncTp, QK_51>::_S_integrate));
	  break;
	case QK_61: __qk_int_func =
	  (qk_int_func_type)(&(__detail::qk_integrator<_VecTp, _FuncTp, QK_61>::_S_integrate));
	  break;
	default:
