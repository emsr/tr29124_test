...
template<typename Tp>
  ...
  test_integral(Tp proto = Tp{})
  {
    ...
    __gnu_ext::midpoint_integral<fun_t, Tp> mq(fun, Tp{0}, PI, Tp{0.0000001});
    std::cout << mq() << '\n';
    ...
    __gnu_ext::midpoint_integral<decltype(one), Tp> t0(one, a, b, err);
    Tp a0 = t0();
    Tp e0 = b - a;
    std::cout << "one     : "
	      << ' ' << std::setw(w) << a0
    ...
    __gnu_ext::midpoint_integral<decltype(ex), Tp> t1(ex, a, b, err);
    Tp a1 = t1();
    Tp e1 = (b * b - a * a) / Tp{2};
    std::cout << "ex      : "
	      << ' ' << std::setw(w) << a1
    ...
    __gnu_ext::midpoint_integral<decltype(cos2), Tp> t2(cos2, a, b, err);
    Tp a2 = t2();
    Tp e2 = PI / Tp{2};
    std::cout << "cos2    : "
	      << ' ' << std::setw(w) << a2
    ...
    __gnu_ext::midpoint_integral<decltype(sin2), Tp> t3(sin2, a, b, err);
    Tp a3 = t3();
    Tp e3 = PI / Tp{2};
    std::cout << "sin2    : "
	      << ' ' << std::setw(w) << a3
    ...
    __gnu_ext::midpoint_integral<decltype(j1), Tp> t4(j1, a, b, err);
    Tp a4 = t4();
    ...
    a = Tp{0};
    b = Tp{10} * PI;
    __gnu_ext::midpoint_integral<decltype(foo), Tp> t5(foo, a, b, err);
    Tp a5 = t5();
    ...
    __gnu_ext::midpoint_integral<decltype(foonum), Tp> t5n(foonum, a, b, err);
    Tp a5n = t5n();
    ...
    __gnu_ext::midpoint_integral<__gnu_cxx::_Polynomial<Tp>, Tp> t6(poly1, a, b, err);
    Tp a6 = t6();
    ...
    a = Tp{0};
    b = PI;
    __gnu_ext::midpoint_integral<decltype(funk1), Tp> t7(funk1, a, b, err);
    Tp a7 = t7();
    Tp e7 = Tp{0};
    std::cout << "funk1   : "
	      << ' ' << std::setw(w) << a7
    ...
    __gnu_ext::midpoint_integral<decltype(funk1num), Tp> t7n(funk1num, a, b, err);
    Tp a7n = t7n();
    Tp e7n = Tp{0};
    std::cout << "funk1num: "
	      << ' ' << std::setw(w) << a7n
    ...
    __gnu_ext::midpoint_integral<decltype(funk2), Tp> t8(funk2, a, b, err);
    Tp a8 = t8();
    Tp e8 = Tp{0};
    std::cout << "funk2   : "
	      << ' ' << std::setw(w) << a8
    ...
    __gnu_ext::midpoint_integral<decltype(funk2num), Tp> t8n(funk2num, a, b, err);
    Tp a8n = t8n();
    Tp e8n = Tp{0};
    std::cout << "funk2num: "
	      << ' ' << std::setw(w) << a8n
