...
main()
{
  ...
  std::cout << "R_C(0, i) = " << __gnu_cxx::ellint_rc(std::complex<double>(0.0, 0.0),
  ...
  std::cout << "R_J(2, 3, 4, -1 + i) = " << __gnu_cxx::ellint_rj(std::complex<double>(2.0,0.0),
  ...
  std::cout << "R_D(0, i, -i) = " << __gnu_cxx::ellint_rd(std::complex<double>(0.0,0.0),
						 std::complex<double>(0.0,1.0),
						 std::complex<double>(0.0,-1.0)) << std::endl;  //  1.2708196271910 + i 2.7811120159521
  std::cout << "R_D(0, i - 1, i) = " << __gnu_cxx::ellint_rd(std::complex<double>(0.0,0.0),
						    std::complex<double>(-1.0,1.0),
  ...
  std::cout << "R_G(0, i, -i) = " << __gnu_cxx::ellint_rg(std::complex<double>(0.0,0.0),
						 std::complex<double>(0.0,1.0),
