/*
$HOME/bin_tr29124/bin/g++ -std=gnu++17 -g -Wall -Wextra -Wno-psabi -I. -o test_decimal test_decimal.cpp -lquadmath
...
template<typename _DecTp>
  test_decimal()
  {
    std::cout.precision(std::numeric_limits<_DecTp>::max_digits10);

    auto x = 0.00004472229441850588228136889483397204368247d;
    auto y = -1.00200035757357000394547575997277994404042345d;
    int n = 5;
    int exp = 3;
    _DecTp m = 4.0d;
    _DecTp b = 2.5d;
...
main()
{
  test_decimal<std::decimal::decimal32>();
}
