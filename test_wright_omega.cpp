/*
$HOME/bin_tr29124/bin/g++ -std=gnu++17 -g -Wall -Wextra -Wno-psabi -I. -o test_wright_omega test_wright_omega.cpp -lquadmath -lmpfr
...
template<typename _Tp>
		 ...
		 std::complex<_Tp>& __condn)
  {
    ...
    const auto _S_pi = __gnu_cxx::__const_pi(__z.real());
...
template<typename _Tp>
  ...
  {
    using _Cmplx = std::complex<_Tp>;
    const auto _S_1de = __gnu_cxx::__const_one_div_e(__x);
    if (__x < _S_1de)
