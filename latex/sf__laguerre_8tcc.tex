...
\begin{DoxyCompactList}\small\item\em This routine returns the associated Laguerre polynomial of order $ n $, degree $ \alpha $\+: $ L_n^\alpha(x) $ by recursion. \end{DoxyCompactList}\end{DoxyCompactItemize}
