...
void fdjac2(void f(),int m,int n,double x[],double fvec[],double **fjac,
...
void lmdif(void f(),int m,int n,double x[],int msk[],double fvec[],
...
int lmdif0(void f(),int m,int n,double x[],int msk[],double fvec[],
