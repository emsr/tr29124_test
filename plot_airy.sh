...
plot [-20.0:5.0][-1.0:+1.0] "plot/scorer_float.txt" using 1:2 with lines title "Gi", "" using 1:3 with lines title "Gi'", "" using 1:4 with lines title "Hi", "" using 1:5 with lines title "Hi'"
plot [-20.0:5.0][-1.0:+1.0] "plot/scorer_double.txt" using 1:2 with lines title "Gi", "" using 1:3 with lines title "Gi'", "" using 1:4 with lines title "Hi", "" using 1:5 with lines title "Hi'"
plot [-20.0:5.0][-1.0:+1.0] "plot/scorer_long_double.txt" using 1:2 with lines title "Gi", "" using 1:3 with lines title "Gi'", "" using 1:4 with lines title "Hi", "" using 1:5 with lines title "Hi'"
...
splot [-5:5][-5:5][0:12] "plot/airy_complex_float.txt" index 0 with lines title "|Ai(z)|^{1/6}"
splot [-20:5][-5:5][-20:20] "plot/airy_complex_float.txt" index 1 with lines title "Re[Ai(z)]"
splot [-20:5][-5:5][-20:20] "plot/airy_complex_float.txt" index 2 with lines title "Im[Ai(z)]"
splot [-20:5][-5:5][-3.2:+3.2] "plot/airy_complex_float.txt" index 3 with lines title "Arg[Ai(z)]"
splot [-5:5][-5:5][0:12] "plot/airy_complex_float.txt" index 4 with lines title "|Bi(z)|^{1/6}"
splot [-20:5][-5:5][-20:20] "plot/airy_complex_float.txt" index 5 with lines title "Re[Bi(z)]"
splot [-20:5][-5:5][-20:20] "plot/airy_complex_float.txt" index 6 with lines title "Im[Bi(z)]"
splot [-20:5][-5:5][-3.2:+3.2] "plot/airy_complex_float.txt" index 7 with lines title "Arg[Bi(z)]"
splot [-20:5][-5:5][-2:2] "plot/airy_complex_float.txt" index 8 with lines title "Wronski"
...
splot [-5:5][-5:5][0:12] "plot/airy_complex_long_double.txt" index 0 with lines title "|Ai(z)|^{1/6}"
splot [-20:5][-5:5][-20:20] "plot/airy_complex_long_double.txt" index 1 with lines title "Re[Ai(z)]"
splot [-20:5][-5:5][-20:20] "plot/airy_complex_long_double.txt" index 2 with lines title "Im[Ai(z)]"
splot [-20:5][-5:5][-3.2:+3.2] "plot/airy_complex_long_double.txt" index 3 with lines title "Arg[Ai(z)]"
splot [-5:5][-5:5][0:12] "plot/airy_complex_long_double.txt" index 4 with lines title "|Bi(z)|^{1/6}"
splot [-20:5][-5:5][-20:20] "plot/airy_complex_long_double.txt" index 5 with lines title "Re[Bi(z)]"
splot [-20:5][-5:5][-20:20] "plot/airy_complex_long_double.txt" index 6 with lines title "Im[Bi(z)]"
splot [-20:5][-5:5][-3.2:+3.2] "plot/airy_complex_long_double.txt" index 7 with lines title "Arg[Bi(z)]"
splot [-20:5][-5:5][-2:2] "plot/airy_complex_long_double.txt" index 8 with lines title "Wronski"
