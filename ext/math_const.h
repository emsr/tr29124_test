...
_GLIBCXX_BEGIN_NAMESPACE_VERSION
  ...
  template<typename _RealType>
	...
	= 2.645751311064590590501615753639260425706L;
      // Constant @f$ \cbrt(3) @f$.
      static constexpr _RealType __cbrt_3
  ...
  template<typename _RealType>
    constexpr _RealType __math_constants<_RealType>::__ln_pi;
  template<typename _RealType>
  ...
  template<typename _RealType>
    constexpr _RealType __math_constants<_RealType>::__root_3_div_2;
  template<typename _RealType>
    constexpr _RealType __math_constants<_RealType>::__root_5;
  template<typename _RealType>
    constexpr _RealType __math_constants<_RealType>::__root_7;
  template<typename _RealType>
    constexpr _RealType __math_constants<_RealType>::__cbrt_3;
  template<typename _RealType>
  ...
  template<typename _RealType>
    ...
    noexcept(noexcept(std::is_fundamental<_RealType>::value))
    { return __math_constants<_RealType>::__2_pi; }
  ...
  template<typename _RealType>
    constexpr _RealType
    __const_root_3_div_2(_RealType = _RealType{})
    noexcept(noexcept(std::is_fundamental<_RealType>::value))
    { return __math_constants<_RealType>::__root_3_div_2; }
  ...
  template<typename _RealType>
    constexpr _RealType
    __const_cbrt_3(_RealType = _RealType{})
    noexcept(noexcept(std::is_fundamental<_RealType>::value))
    { return __math_constants<_RealType>::__cbrt_3; }
