...
!  Discussion:
!
!    TEST_VALUES_PRB tests the TEST_VALUES library.
!
!  Licensing:
!
...
!
  ...
  call elliptic_ka_values_test ( )
  call elliptic_km_values_test ( )
...
subroutine elliptic_ka_values_test ( )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'ELLIPTIC_KA_VALUES_TEST:'
...
subroutine elliptic_km_values_test ( )
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'ELLIPTIC_KM_VALUES_TEST:'
...
!
  ...
  do
    ...
    write ( *, '(2x,g10.4,2x,g10.4,2x,g24.16)' ) a, x, fx
...
!
  ...
  do
    ...
    write ( *, '(2x,g10.4,2x,g10.4,2x,g14.6)' ) a, x, fx
